(()=>{
  ...
  resume.innerHTML=`
    <section class="resume-profile" aria-labelledby="resumeTitle">
      <div>
        <span class="resume-label">Resume · Updated 2026.07.20</span>
        ...
        <div class="resume-stats">
          ...
          <div class="resume-stat"><strong>10</strong><span>기재 경력</span></div>
    ...
    <section class="resume-career" aria-label="이력서 상세">
      <header class="resume-career-head"><div><span class="resume-label">Career record</span><h2>Experience</h2></div><p>경력 · 학력 · 자격 · 희망근무조건</p></header>
